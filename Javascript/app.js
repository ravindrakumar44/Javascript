...
// console.log("after lowercase : ",newName);
...
// let students = ["ravi" , "chotu" , "raj"];

// let info = ["ravindra" , 75 , 18];
...
// let all = secondary.concat(primary);
// console.log(all);
...
// console.log(colors.slice(-3).reverse());
...
// console.log(colors);
// colors.splice(0,1,"grey","black");
// console.log(colors);
// colors.splice(2,0,"pink");
// console.log(colors);

// let cars = ["toyoto","gwagon","xuv","maruti","bmw","ferrari"];
// cars.sort();
// console.log(cars);
...
// let students = [["aman",95] , ["arjun",96] , ["karan",99]];
...
// let country = ["United States of America","Germany","Australia","France"];
...
// console.log(findLargest(country));
...
//     let diff = end - start;
//     return random = Math.floor(Math.random() * diff) + start;
// }
...
// const power = (a,b) => {
//     console.log(Math.pow(a,b)); // or a**b
// }
// power(2,3);
